      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <form class="row datos-compra">
            ...
            <div class="clear"></div>
             <div class="pagaar">
              <p><b>Plan premium IdeeAR+</b></p>
              <p><span>Importe</span><b class="monto">$250,000</b></p>
              
                <button type="button" class="button-pago" onclick="window.location.href='pago-ok.php'">PAGAR</button>
