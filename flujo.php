            ...
            <div class="row back-white2 no-shadow">
               ...
               <section id="contenido1">
                  <div class="col-xs-12 col-sm-12 col-md-5 line-modal">
                     <div class="">
                        ...
                        <div class="col-xs-12 col-md-3">
                           <img class="img-responsive codigo-qr" src="images/codigo-qr.jpg">
                        </div>
                        <div class="col-xs-12 col-md-5 margin-box-url">
                           ...
                           <div class="col-xs-3 col-md-4">
                              <p class="si-resp">Si</p>
                           </div>
                        </div>
                        <div class="col-md-12">
                           <br>
                           <p class="text-azul2 qr-cont-resp"><b>Contenido</b></p>
                  ...
                  <div class="col-xs-12 col-md-6">
                     <h3 class="per-bases vista-p2 qr-cont-resp">Magic QR</h3>
                     <p class="text-azul text-ic-ap">Icono de la Aplicación</p>
                     <br>
                     <div class="col-xs-12 col-md-2 borders">
                     ...
                     <div class="col-xs-12 col-md-12">
                        <p style="margin-top: 15px; margin-left: 10px;" class="text-azul2 alain"><b>Icono de la Campaña</b></p>
                     </div>
                     <div class="col-md-12 text-center">
                        <p>Selecciona la imagen en donde se generará el Magic QR.<br>
                           La imagen no debe pesar más de XXX Kbs
                        </p>
                     </div>
                  ...
                  <div class="row">
                     <div class="col-xs-12 col-md-7 col-lg-6">
                        <div class="col-xs-12 col-md-12">
                           ...
                           <p class="text-azul2 text-azul-resp">Icono de la Aplicación</p>
                        </div>
                        ...
                        <div class="col-md-12">
                           <br>
                           <div class="col-xs-12 col-md-3">
                              <p class="text-azul3 text-resp3-azul">Incluir Tab de promoción</p>
                           </div>
                           <div class="col-xs-12 col-md-9">
                              <div class="onoffswitch">
                                 <input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox" id="myonoffswitch">
                        ...
                        <div class="col-md-12">
                           <br>
                           <div class="col-md-9">
                              <p class="text-azul4 text-resp-azul text-resp3-azul">Texto de la promoción</p>
                           </div>
                           <div class="col-md-3">
                              <p class="text-azul3 text-col-responsive">Colores</p>
                           </div>
                           <div class="col-md-8 form-app-sec">
                              <input class="form-d-ap form-diseno-app" type="text" name="" placeholder="Visita www.promocion50.com">
                           </div>
                           <div class="col-md-2 padin-resp-colors">
                        ...
                        <div class="col-md-12">
                           <br>
                           <p class="text-azul2 margin-rep-url">URL de la Promoción</p>
                           <input class="form-diseno-app margin-b-ux" type="text" name="" placeholder="http://promocioncliente.com">
                        </div>
                        <div class="col-md-12">
                           <br>
                           <h5 style="color:#55acee;" class="text-azul2 margin-rep-url">Pantalla de Inicio (Splash screen)</h5>
                        </div>
                        <div class="col-md-12">
                           <br>
                           <div class="col-md-9">
                              <p class="text-azul4 margin-t-b">Texto de Bienvenida</p>
                           </div>
                           <div class="col-md-3">
                              <p class="text-azul3 margin-rep-url-col">Colores</p>
                           </div>
                           <div class="col-md-8 form-app-sec">
                              <input class="form-diseno-app margin-b-ux-sec" type="text" name="" placeholder="Bienvenido a Pruebas UX / UI Ideeo Labs">
                           </div>
                           <div class="col-md-2 padin-resp-colors">
                              <a class="selector-color" href="#"></a>
                              <p class="color-code">#edf0f5</p>
                        ...
                        <div class="col-md-12  guardar-col">
                           <a class="guardar g-resp" href="#">GUARDAR</a>
                        </div>
                     </div>
               ...
               <section id="contenido3">
                  ...
                  <div class="col-xs-12 col-md-11 paddin-detonadores-modal">
                     <div class="col-xs-12 col-md-3 col-lg-2 border-content-style2">
